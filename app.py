...
shape for input_image: {input_image.shape}. Expected shape: (batch_size,
...
uploaded_model = st.sidebar.file_uploader("Upload a Keras model
(.keras)", type=["keras"])
...
        else:
            st.error("The uploaded folder does not contain all required NIfTI files (T1n, T1c, T2f,
T2w).")
Save
